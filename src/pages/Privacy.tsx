    ...
    <div className="section-padding">
      ...
      <div className="container-narrow mx-auto">
        ...
        <div className="prose prose-sm max-w-none text-muted-foreground space-y-6">
          ...
          <p><strong className="text-foreground">Permissions and why they exist.</strong> Notifications, so the app can remind you about a task or tell you a time box has finished. Exact alarms, so those reminders arrive at the minute you set rather than whenever the system feels like it. Restart notification and wake lock, so a reminder you set survives a reboot and can still wake the screen. Internet access, which the app framework declares by default and which the app uses only to load its own bundled content. The app asks for no location, no camera, no contacts and no files.</p>
